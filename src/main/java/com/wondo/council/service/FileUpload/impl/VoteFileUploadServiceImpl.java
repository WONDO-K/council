...
@Transactional
@Log4j2
public class VoteFileUploadServiceImpl implements VoteFileUploadService {
    ...
    public String uploadFile(MultipartFile file) {
        try {
            if(file!=null && !file.isEmpty()){
                ...
                voteImage.setFileName(fileName);
                voteImage.setFilePath(uploadPath);
                voteImage.setFileSize(file.getSize());
